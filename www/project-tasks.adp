...
<p>
<%=[lang::message::lookup "" intranet-reporting.ListOfCurrentProjectTasksIntro "This report lists time sheet tasks for projects of type \"Gantt Project\" (including sub-types)."]%>
</p>
<br><br><br>
